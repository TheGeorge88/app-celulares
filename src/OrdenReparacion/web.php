...
Route::middleware(['auth'])->prefix('ordenes-reparacion')->group(function () {
    ...
    Route::post('/', [OrdenReparacionWebController::class, 'store'])->name('ordenes-reparacion.store');
    ...
    Route::put('/{id}', [OrdenReparacionWebController::class, 'update'])->name('ordenes-reparacion.update');
    Route::delete('/{id}', [OrdenReparacionWebController::class, 'destroy'])->name('ordenes-reparacion.destroy');
});
